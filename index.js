      ...
      cartEl.innerHTML += `
          <div class="cartItem">
            <span>
              ...
              <p class="cartItmPricing" id="cartItmQty">${
                el.itemQty
              }     x     </p>
              <p class="cartItmPricing" id="cartItmUnitPrice"> $${
                el.itemPrice
              }</p>
              <p class="cartItmPricing" id="cartItmUnitTotal">$${(
                el.itemQty * el.itemPrice
              ).toFixed(2)}</p>
            </span>
            <button type="button" id="btn-remove-${el.id}" onclick="rmvCart(${
        el.id
      })">
      ...
      <div class="confCartContainer">
        <div class="confCartItem">
          ...
          <div class="cartItmtTotalCnt">
            <p class="cartItmPricing" id="confCartItmUnitTotal">$${(
              el.itemQty * el.itemPrice
            ).toFixed(2)}</p>
          </div>
        </div>
